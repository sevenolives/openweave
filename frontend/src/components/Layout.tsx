              ...
              {userMenuOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-1 w-52 bg-[#111118] border border-[#222233] rounded-xl shadow-lg z-50 py-1">
                    ...
                    <button onClick={() => { setUserMenuOpen(false); handleLogout(); }} className="w-full text-left px-4 py-2.5 text-sm text-red-400 hover:bg-red-900/10 flex items-center gap-2">
