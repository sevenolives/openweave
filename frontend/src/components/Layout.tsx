...
const NAV_KEYS = [
  { path: '/projects', label: 'Dashboard', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
  ...
  { path: '/settings?tab=members', label: 'Team', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
              ...
              {userMenuOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-1 w-48 bg-[#111118] border border-[#222233] rounded-xl shadow-lg z-50 py-1">
                    ...
                    <button onClick={() => { setUserMenuOpen(false); handleLogout(); }} className="w-full text-left px-4 py-2.5 text-sm text-red-400 hover:bg-red-900/200/10 flex items-center gap-2">
