    ...
    <Layout>
      <div className="p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          <button onClick={() => router.push('/projects')} className="p-2 rounded-lg hover:bg-gray-100 text-gray-400">
          ...
          <button onClick={() => router.push(`/tickets?project=${project.id}`)} className="ml-auto px-4 py-2 text-sm font-medium text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors">
            View Tickets →
          </button>
        </div>
