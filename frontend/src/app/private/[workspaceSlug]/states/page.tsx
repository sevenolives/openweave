...
function StateMachineSettings({
  ...
  return (
    <div style={{ background: '#0a0a0a', borderRadius: 16, padding: isMobile ? '20px 12px' : '32px 24px', color: '#e5e7eb' }}>
      <h2 style={{ fontSize: 'clamp(20px, 4vw, 24px)', fontWeight: 700, color: 'white', marginBottom: 8 }}>Ticket States</h2>
  ...
  return (
    <Layout>
      <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold text-white mb-6">{workspace.name} — Ticket States</h1>

        {/* Workspace Setting for status restrictions */}
