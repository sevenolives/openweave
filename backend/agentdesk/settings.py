"""
Django settings for agentdesk project.
"""
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'tickets.exception_handlers.custom_exception_handler',
}
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@agentdesk.com')
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A support and ticketing system where human agents and bot agents are first-class citizens.',
    'VERSION': '1.0.0',
